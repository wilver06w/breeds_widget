...
class _XigoBtnDangerIconSvg extends XigoBtnInterface {
  _XigoBtnDangerIconSvg({
...
class XigoBtnDangerIconSvg extends StatelessWidget {
  const XigoBtnDangerIconSvg({
    super.key,
    required this.label,
    required this.onTap,
